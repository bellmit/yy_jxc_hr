...
public class AceAddHandler implements IAppEventHandler<AddEvent> {
  ...
  public void handleAppEvent(AddEvent e) {
    ...
    panel.setHeadItem("billtype", "JX07");
...
//		UIRefPane refPane1=(UIRefPane) panel.getHeadItem("billmaker").getComponent();
//		refPane1.setRefModel(new DeptRefModel());
//		refPane1.getRefModel().setRefTitle("部门参照");
