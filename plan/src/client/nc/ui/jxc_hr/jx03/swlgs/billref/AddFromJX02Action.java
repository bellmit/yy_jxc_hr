 ...
 * @date 下午1:28:05
 * @todo 实物量工时参照派工卡按钮，弹框，可修改从派工卡默认带过来的剩余工时
 */
public class AddFromJX02Action extends AbstractReferenceAction {
	...
	public void doAction(ActionEvent arg0) throws Exception {
		...
		IBillReferQuery qcDLG=loadUserQuery(getModel().getContext()
				...
				.getPk_loginUser(), "68H10102","JX02", "JX02", "qt", null);
		//派工单功能节点号：68H10102  派工单默认查询模板：qt
		if (qcDLG.showModal() == UIDialog.ID_OK) {
			...
			if(bvos!=null&&bvos.length!=0){
				ShowJX02BodyDlg dlg= new ShowJX02BodyDlg(editor.getParent(),bvos);
				dlg.showModal();
			}
			else{
