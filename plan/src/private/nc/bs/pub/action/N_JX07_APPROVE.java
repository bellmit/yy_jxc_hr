...
public class N_JX07_APPROVE extends AbstractPfAction<AggOrderStartVO> {

	public N_JX07_APPROVE() {
		super();
	}
	...
	protected CompareAroundProcesser<AggOrderStartVO> getCompareAroundProcesserWithRules(
		...
		CompareAroundProcesser<AggOrderStartVO> processor = new CompareAroundProcesser<AggOrderStartVO>(
				OrderstartPluginPoint.APPROVE);
		IRule<AggOrderStartVO> rule = null;
		rule = new nc.bs.pubapp.pub.rule.ApproveStatusCheckRule();

		processor.addBeforeRule(rule);
		
		rule = new nc.bs.jxc_hr.bg.orderstart.ace.rule.InsertGLdefdocRule();
