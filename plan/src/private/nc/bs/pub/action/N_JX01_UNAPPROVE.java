...
public class N_JX01_UNAPPROVE extends AbstractPfAction<SGDVO> {

	public N_JX01_UNAPPROVE() {
		super();
	}
	...
	protected CompareAroundProcesser<SGDVO> getCompareAroundProcesserWithRules(
		...
		rule=new nc.bs.jxc_hr.bg.sgd.ace.rule.BeforeUnApproveRule();
		processor.addBeforeRule(rule);
