...
public class JX04FuncNodeInitDataListenenr extends
		DefaultFuncNodeInitDataListener {
	private static final int datatype=68050104;
	...
	public void initData(FuncletInitData data) {
		...
		if(data.getInitType()==datatype){
			if ( data.getInitData() instanceof LinkMaintainData) {
